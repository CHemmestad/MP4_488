...
#define PID_YAW_RATE_KD  15.0
#define PID_YAW_RATE_INTEGRATION_LIMIT     166.7

#define PID_ROLL_KP  20.0
#define PID_ROLL_KI  6.0
#define PID_ROLL_KD  0.01
#define PID_ROLL_INTEGRATION_LIMIT    20.0

#define PID_PITCH_KP  30.0
#define PID_PITCH_KI  6.0
#define PID_PITCH_KD  0.01
#define PID_PITCH_INTEGRATION_LIMIT   20.0

#define PID_YAW_KP  20.0
#define PID_YAW_KI  0.0
#define PID_YAW_KD  2.0
